...
const leftBg2 = document.querySelector(".bg-inner-section-left2");
const rightBg2 = document.querySelector(".bg-inner-section-right2");
...
function updateService(index) {
  ...
  setTimeout(() => {
    ...
    // SECONDARY blocks (faded version)
    leftBg2.style.backgroundColor = hexToRGBA(data.color, 0.3);
    rightBg2.style.backgroundColor = hexToRGBA(data.color, 0.3);

    middleHex.style.backgroundColor = "#ffffff0";
